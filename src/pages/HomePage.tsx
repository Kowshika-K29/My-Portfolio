  ...
  return (
    <>
      <section className="bg-[#000000] text-white  w-full">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between px-6 py-10 gap-10 md:gap-20 px-25 pd-25">
  {/* Text section */}
  <div className="text-center md:text-left">
    <h2 className="text-4xl text-white">
      Hello <span className="text-orange-400 font-extrabold">.</span>
    </h2>
    <div className="flex items-center justify-center md:justify-start -ml-0 md:-ml-24">
